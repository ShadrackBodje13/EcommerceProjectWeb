        ...
        <!-- row -->
            ...
            <div class="col-md-5 order-details" style="width: 100%;">
                ...
                <div id="order_summary" class="order-summary">
                    ...
                    <!--Quand il y a les produits, il est possible de -->
                    @if($all != null)
                    <div class="rTable">
                        <div class="rTableRow">
...
<script>
   ...
   //TO DO: ajax will take place
    ...
    $('.delete_item').click(function () {
        ...
        var serial= $(this).val();   //serial est le quatrième élément de la colonne de vente
        var token=$("input[name=_token]").val();
    ...
    $(document).ready(function() {
		...
		// Validation Formulaire et soumission du formulaire
		$("#signupForm").validate({
			rules: {
				name: "required",
				email: {
